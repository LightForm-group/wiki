...
The documentation of the model, which describes the equations used and the corresponding entries in the input files, can be downloaded [here](https://github.com/LightForm-group/Damask-KWN/blob/main/model_documentation/fullfield-kwn.pdf)
